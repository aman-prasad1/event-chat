...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("signup submit", e.target);
  };
    ...
    <div className="min-h-screen w-full flex items-center justify-center px-4" style={{ backgroundColor: 'var(--color-primary)', fontFamily: 'var(--font-sans)' }}>
      <main className="w-full max-w-md rounded-2xl shadow-xl p-8" style={{ backgroundColor: 'var(--color-primary)', borderWidth: '1px', borderColor: 'var(--color-border)' }}>
        <header className="mb-6 text-center">
          <h1 className="text-2xl font-semibold" style={{ color: 'var(--color-text-primary)' }}>Create your account</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--color-text-secondary)' }}>Join the conversation — it only takes a minute.</p>
        </header>

        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="first_name" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-text-primary)' }}>First name</label>
            <input
              type="text"
              id="first_name"
              name="first_name"
          ...
          <div>
            <label htmlFor="last_name" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-text-primary)' }}>Last name</label>
            <input
              type="text"
              id="last_name"
              name="last_name"
          ...
          <div>
            <label htmlFor="username" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-text-primary)' }}>Username</label>
            <input
              type="text"
              id="username"
              name="username"
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-text-primary)' }}>Password</label>
          ...
          <p className="text-center text-sm mt-3" style={{ color: 'var(--color-text-secondary)' }}>Already have an account? <Link to="/login" className="font-medium hover:underline transition-colors" style={{ color: 'var(--color-accent-primary)' }}>Sign in</Link></p>
        </form>
      </main>
    </div>
  );
